...
import { DecodeHintType, RGBLuminanceSource } from '@zxing/library';
@Component({
...
export class ProcesarfotosPage implements OnInit {
  ...
  constructor(public route: ActivatedRoute, public Router: Router, private navCtrl: NavController, private file: File, public toastController: ToastController, public renaper: RenaperService) { }
