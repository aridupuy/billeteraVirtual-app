...
@Component({
  selector: 'app-selecciona-metodo-pago',
  templateUrl: './selecciona-metodo-pago.page.html',
  styleUrls: ['./selecciona-metodo-pago.page.scss'],
})
export class SeleccionaMetodoPagoPage implements OnInit {
  ...
  platacuenta() {
    this.visiblePlata = true
    this.visibleDebito = false
  }
  tarjetadebito(){
    this.visibleDebito = true
    this.visiblePlata = false
  }
  Continuar() {
    this.navCtrl.navigateForward("transferencia-confirma")
  }
