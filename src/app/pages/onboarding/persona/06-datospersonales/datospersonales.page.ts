...
export class DatospersonalesPage implements OnInit {
  ...
  constructor(public platfrom: Platform, public screenOrientation: ScreenOrientation, protected navCtrl: NavController, public renaper: RenaperService, public route: ActivatedRoute, public Router: Router, public location: LocationService) { }
