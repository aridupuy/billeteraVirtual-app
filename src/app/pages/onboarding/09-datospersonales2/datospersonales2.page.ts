...
export class Datospersonales2Page implements OnInit {
  ...
  constructor(private navCtrl: NavController, public route: ActivatedRoute, public Router: Router, public registroService:RegistroService,public location: LocationService) { }
